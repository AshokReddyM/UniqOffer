...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ShopsViewHolder> {

    private ArrayList<ImageModel> imageModelArrayList = new ArrayList<>();
    private Context context;

    public RecyclerViewAdapter(Context context, ArrayList<ImageModel> horizontalList) {
